 function initApp() {
     ...
     var ref = new firebase.database().ref('TOairport/Newark');
     var now = Date.now();
     var cutoff = now;
     var old = ref.orderByChild('rideDate').endAt(now).limitToLast(1);
     var listener = old.on('child_added', function(snapshot) {
     ...
     var ref = new firebase.database().ref('TOairport/Laguardia');
     var now = Date.now();
     var cutoff = now;
     var old = ref.orderByChild('rideDate').endAt(now).limitToLast(1);
     var listener = old.on('child_added', function(snapshot) {
     ...
     var ref = new firebase.database().ref('FROMairport/JFK');
     var now = Date.now();
     var cutoff = now;
     var old = ref.orderByChild('rideDate').endAt(now).limitToLast(1);
     var listener = old.on('child_added', function(snapshot) {
     ...
     var ref = new firebase.database().ref('FROMairport/Newark');
     var now = Date.now();
     var cutoff = now;
     var old = ref.orderByChild('rideDate').endAt(now).limitToLast(1);
     var listener = old.on('child_added', function(snapshot) {
     ...
     var ref = new firebase.database().ref('FROMairport/Laguardia');
     var now = Date.now();
     var cutoff = now;
     var old = ref.orderByChild('rideDate').endAt(now).limitToLast(1);
     var listener = old.on('child_added', function(snapshot) {
